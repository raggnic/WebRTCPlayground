...
public class SignalerUI : MonoBehaviour
{
    ...
    private void Start()
    {
        //string localPeerId = Signaler.LocalPeerId;
        //DeviceNameLabel.text = localPeerId;
        //Debug.Log($"NodeDSS local peer ID : {localPeerId}");

        //if (!string.IsNullOrEmpty(Signaler.RemotePeerId))
        //{
        //    RemotePeerId.text = Signaler.RemotePeerId;
        //}
    ...
    public void StartConnection()
    {
        ...
        //    Signaler.RemotePeerId = RemotePeerId.text;
